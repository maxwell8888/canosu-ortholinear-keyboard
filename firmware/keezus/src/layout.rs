...
pub static LAYERS: keyberon::layout::Layers<NUM_COLS, NUM_ROWS, NUM_LAYERS, CustomActions> = [
    ...
    */
    ...
    [k(LShift),   k(NonUsBslash), k(Z),    k(X),   k(C),    k(V),      k(B),     k(F10),   k(F11),    k(F12),      Trans,        Trans,     Trans,     Trans,   Trans,     Trans],
    [k(LCtrl),    k(LGui),        k(LAlt), Trans,  Trans,   k(LCtrl),  k(Space), Trans,    Trans,     Trans,       Trans,        Trans,     Trans,     Trans,   Trans,     Trans,],
    // right side                                                                                                                                                  
    [Trans,       Trans,          Trans,   Trans,  k(Kb6),   k(Kb7),   k(Kb8),   k(Kb9),   k(Kb0),    k(Minus),    k(Equal),     k(BSpace), k(Insert), k(Home), k(PgUp),   Trans],
    [Trans,       Trans,          Trans,   Trans,  k(Y),     k(U),     k(I),     k(O),     k(P),      k(LBracket), k(RBracket),  k(Enter),  k(Delete), k(End),  k(PgDown), Trans],
    [Trans,       Trans,          Trans,   Trans,  k(H),     k(J),     k(K),     k(L),     k(SColon), k(Quote),    k(NonUsHash), k(Enter),  Trans,     Trans,   Trans,     Trans],
    [Trans,       Trans,          Trans,   Trans,  k(N),     k(M),     k(Comma), k(Dot),   k(Slash),  k(RShift),   k(RShift),    Trans,     Trans,     k(Up),   Trans,     Trans],
